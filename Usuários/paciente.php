...
<body>
        ...
        <section class="form-section">
            <div class="form-container">
                ...
                <div class="painel-funcionalidades">
                    ...
                    <div class="card-cardeneta" style="margin-top: 30px;">
                        <h3><i class="fas fa-envelope"></i> Mensagens Recebidas</h3>
                        
                        <?php if(empty($mensagens_recebidas)): ?>
                            <p style="color:#666; padding:15px;">Sua caixa de entrada está vazia.</p>
                        <?php else: ?>
                                ...
                                <?php foreach ($mensagens_recebidas as $msg): ?>
                                    <li class="message-item">
                                        ...
                                        <div class="message-header" onclick="toggleMessage(this)">
                                            <span class="subject">
                                                <i class="fas fa-envelope" style="color:#3d8cb1; margin-right:5px;"></i>
                                                <?php echo htmlspecialchars($msg['assunto']); ?>
                                            </span>
                                            <div class="meta-info">
                                                <span><?php echo date('d/m/Y', strtotime($msg['data_envio'])); ?></span>
    ...
    <div id="modal-solicitacao" class="modal-logout2">
        <div class="modal-content-logout2" style="height:auto; text-align:left; max-width:500px;">
            <h3>Nova Solicitação</h3>
            <p>Sua mensagem será visível para <strong>todos os enfermeiros</strong> do seu posto.</p>
            ...
            <form id="form-solicitacao">
                ...
                <div class="input-group">
                    ...
                    <textarea name="corpo" rows="5" style="width:100%; padding:10px; border:1px solid #ccc; border-radius:5px;" required placeholder="Descreva detalhadamente o que você precisa..."></textarea>
                </div>
