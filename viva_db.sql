...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 23/11/2025 às 17:53
...
(1, 'Nenhuma', 'Mantenha seus hábitos saudáveis e a vacinação em dia!'),
...
(4, 8, '14679958600', '35988760674', 'Jardim Califórnia Rua 14 Casa 188', 2);
...
(8, 'Daniel Joás da Costa', 'danielcosta.10d@gmail.com', '$2y$10$Deuu0wiJ.q2oroaWK6NpUeRnt3mna9b8E1jVLu41W1UqPUhB/M3Mi', 'paciente', NULL, '2025-11-22 16:14:34');
...
(7, 'Vacina penta (DTP+Hib+HB) (3ª dose)', '6 meses', 60, NULL);
...
--
ALTER TABLE `pacientes`
  MODIFY `id_paciente_data` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `usuarioprecadastro`
  MODIFY `id_pre_cadastro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
